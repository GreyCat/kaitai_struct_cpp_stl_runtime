...
#elif defined(__MINGW32__) // !__APPLE__ && !_MSC_VER
// MinGW targets Windows (little-endian) but uses GCC, which doesn't have
// _byteswap_* intrinsics. It also lacks <endian.h> and <byteswap.h>.
#define __LITTLE_ENDIAN     1234
#define __BIG_ENDIAN        4321
#define __BYTE_ORDER        __LITTLE_ENDIAN
